...
const CREATE_JOURNAL_ENTRY = gql`
  mutation createJournal($username: String!,$accomplishment: String!, $gratitude: String!, $learning: String!, $lookingForward: String!, $struggle: String!, $entryDate: Date!) {
    createJournal(data: {username: $username,accomplishment: $accomplishment, gratitude: $gratitude, learning: $learning, lookingForward: $lookingForward, struggle: $struggle, entryDate: $entryDate}) {
      id
      username
      accomplishment
      gratitude
...
function JournalEntryForm({ restId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(entryId);
      await publishJournalEntry({ variables: { id: entryId } });
